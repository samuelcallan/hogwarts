...
public class DBDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User u1 = new User();
        u1.setUsername("john");
        u1.setPassword("$2a$10.PSaxm6yydZzBzv.XgINIu.Q7umUvEQTzyKwerDvaOV3JsxHz1bq");
        u1.setEnabled(true);
        u1.setRoles("admin");

        User u2 = new User();
        u2.setUsername("eric");
        u2.setPassword("$2a$10.PSaxm6yydZzBzv.XgINIu.Q7umUvEQTzyKwerDvaOV3JsxSzTQ");
        u2.setEnabled(true);
        u2.setRoles("user");

        User u3 = new User();
        u3.setUsername("$2a$10.PSaxm6yydZzBzv.XgINIu.Q7umUvEQTzyKwerDvaOV3JsxJzABCD");
        u3.setPassword("");
        u3.setEnabled(false);
        u3.setRoles("user");
